...
benchmarkNodeFunction

	: 'void benchmarkNode(void)' (instruction)+ 
	;
...
assignmentTree
	:	'[LineNumber: ' lineNumber ']' assignmentTreePre LineComment?
	;


assignmentTreePre
	:	declarationSpecifiers assignment			';'	 
	|	declaration									//';'?
	|	assignment 									';' 
	|   leftVariable '[' rightExpression ']' 			';'? 
...
//    |   'for' '(' declaration expression? ';' (rightExpression? ',')+ ')' statement
    ...
    |   'default' ':' assignmentTreePre 							//'[LineNumber: ' lineNumber ']'	
    |	'goto' Identifier 							';' 
    |   'continue' 									';' 
    |   'break' 									';' 
    |	'return' rightExpression? 					';'
    //    |   'goto' rightExpression 						';' '[LineNumber: ' lineNumber ']'// GCC extension	
	|   '_Pragma(' '"' .*? '"' ')'
	;
...
relationalExpressionTree
	:	'[LineNumber: ' lineNumber ']' rightVariable relationalOperator ( ('('+)? rightVariable unaryOperator? (')'+)? )+  
	;
...
functionCall
	:	Identifier '(' ')'	
	|	Identifier '(' functionCallVariable ')'
	|	Identifier '(' (functionCallVariable ',')+  functionCallVariable')'
	; 
	
functionCallVariable
	:	rightExpression 
	|	functionCallVariable (unaryOperator| ':' |'?'|'=='|'<'|'>' ) rightExpression 
	|	
	; 
