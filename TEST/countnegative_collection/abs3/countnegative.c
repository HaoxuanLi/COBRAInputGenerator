...
void countnegative_initialize( int Array[MAXSIZE][MAXSIZE]);
void countnegative_init( void );
int countnegative_return( void );
void countnegative_sum( int Array[MAXSIZE][MAXSIZE]);
...
int countnegative_array[MAXSIZE][MAXSIZE];
